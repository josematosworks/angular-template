...
![image](https://github.com/joematthews/angular-template/assets/14097616/bfc78560-98a8-4959-8327-4e94121bf4dd)
...
You can run and explore angular-template on StackBlitz: https://stackblitz.com/github/joematthews/angular-template?preset=node

> [!NOTE]  
> If you run into _any issues at all_ with installing, updating, or using angular-template, then please search through the [issues](https://github.com/joematthews/angular-template/issues). If you do not see a similar issue, then please create a new issue -- thank you! 🙏
...
```sh
git clone --depth=1 --origin=upstream git@github.com:joematthews/angular-template.git new_project_name
```
...
Use the shortcut `CTRL+SHIFT+H` in VSCode to search and replace `angular-template` with your chosen project name.
...
angular-template enables _all_ of the accessibility rules from [angular-eslint](https://github.com/angular-eslint/angular-eslint) by default including image alt text, form labels, no autofocus, valid ARIA, and more.
...
If you run into a problem with any of these accessibility rules I encourage you to open up an [issue](https://github.com/joematthews/angular-template/issues) so we can troubleshoot the the errors or concerns together.
...
Please let me know if more can be done to improve the accessibility of angular-template by creating an issue. Thank you.
...
Recommends VSCode extensions for [Angular](https://marketplace.visualstudio.com/items?itemName=Angular.ng-template), [Editorconfig](https://marketplace.visualstudio.com/items?itemName=EditorConfig.EditorConfig), [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode), [Eslint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint),
...
Uses [Lint-staged](https://www.npmjs.com/package/lint-staged) to run prettier, eslint, cspell, and [tsc-files](https://www.npmjs.com/package/tsc-files) against all staged files before committing to git.
