      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          <div>
            ...
            <h3 i18n class="mt-8 text-lg font-semibold text-black">RxJS</h3>
            <p i18n class="mt-4 text-base text-gray-600">
          ...
          <div>
            ...
            <h3 i18n class="mt-8 text-lg font-semibold text-black">Nx</h3>
            <p i18n class="mt-4 text-base text-gray-600">
          ...
          <div>
            ...
            <h3 i18n class="mt-8 text-lg font-semibold text-black">Jest</h3>
            <p i18n class="mt-4 text-base text-gray-600">
          ...
          <div>
            ...
            <h3 i18n class="mt-8 text-lg font-semibold text-black">ESLint</h3>
            <p i18n class="mt-4 text-base text-gray-600">
          ...
          <div>
            ...
            <h3 i18n class="mt-8 text-lg font-semibold text-black">Zone.js</h3>
            <p i18n class="mt-4 text-base text-gray-600">
          ...
          <div>
            ...
            <h3 i18n class="mt-8 text-lg font-semibold text-black">Prettier</h3>
            <p i18n class="mt-4 text-base text-gray-600">
          ...
          <div>
            ...
            <h3 i18n class="mt-8 text-lg font-semibold text-black">Nx Cloud</h3>
            <p i18n class="mt-4 text-base text-gray-600">
